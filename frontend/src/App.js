...
// Top Bar Component - Mobile Optimized with Multi-Language Support
const TopBar = () => {
      ...
      <div className="md:hidden bg-white px-4 py-2 border-b">
        <form onSubmit={handleSearch} className="relative">
          <input
            ...
            onChange={(e) => setSearchQuery(e.target.value)}
            placeholder={t('searchPlaceholder')}
            className="w-full px-4 py-2 text-sm bg-blue-50 rounded-full focus:outline-none focus:ring-2 focus:ring-blue-300"
            data-testid="mobile-search-input"
          />
          <button type="submit" className="absolute left-2 top-1/2 -translate-y-1/2 text-blue-600">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><Link to="/help" className="text-blue-200 hover:text-white">{t('helpCenter')}</Link></li>
              <li><Link to="/returns" className="text-blue-200 hover:text-white">{t('returns')}</Link></li>
              <li><Link to="/shipping" className="text-blue-200 hover:text-white">{t('shippingInfo')}</Link></li>
              <li><Link to="/track" className="text-blue-200 hover:text-white">{t('trackMyOrder')}</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><Link to="/about" className="text-blue-200 hover:text-white">{t('aboutUs')}</Link></li>
              <li><Link to="/careers" className="text-blue-200 hover:text-white">{t('careers')}</Link></li>
              <li><Link to="/become-seller" className="text-green-300 hover:text-green-200 font-semibold">💼 Become a Seller</Link></li>
              <li><Link to="/affiliate" className="text-blue-200 hover:text-white">{t('affiliateProgram')}</Link></li>
              <li><Link to="/privacy" className="text-blue-200 hover:text-white">{t('privacyPolicy')}</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><Link to="/products?category=Electronics" className="text-blue-200 hover:text-white">{t('electronics')}</Link></li>
              <li><Link to="/products?category=Fashion" className="text-blue-200 hover:text-white">{t('mensFashion')}</Link></li>
              <li><Link to="/products?category=Beauty" className="text-blue-200 hover:text-white">{t('beautyPersonalCare')}</Link></li>
              <li><Link to="/products?category=Home" className="text-blue-200 hover:text-white">{t('homeKitchen')}</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <div className="flex space-x-4 mb-6">
              <a href="#" className="text-2xl hover:text-blue-300">📘</a>
              <a href="#" className="text-2xl hover:text-blue-300">📷</a>
              <a href="#" className="text-2xl hover:text-blue-300">🐦</a>
            </div>
            <h3 className="font-bold text-lg mb-4">{t('paymentMethods')}</h3>
            <div className="flex flex-wrap gap-2">
              <div className="bg-white text-blue-800 px-3 py-1 rounded text-sm font-semibold">Stripe</div>
              <div className="bg-white text-blue-800 px-3 py-1 rounded text-sm font-semibold">Apple Pay</div>
              <div className="bg-white text-blue-800 px-3 py-1 rounded text-sm font-semibold">Tabby</div>
              <div className="bg-white text-blue-800 px-3 py-1 rounded text-sm font-semibold">Tamara</div>
              <div className="bg-white text-blue-800 px-3 py-1 rounded text-sm font-semibold">Mada</div>
            </div>
          </div>
        </div>

        <div className="border-t border-blue-700 pt-8 text-center text-blue-200">
          <p>© 2025 Ocean - Shopping & Services. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
